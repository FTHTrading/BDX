...
| Operations | Qualified custody, cash rails, possession evidence |
...
Qualified custody · cash and metals rails · x402 · UnyKorn mint · UnyKorn Exchange OS · CCT/CCIP
...
Live RFQ, custodian query, cash session, Federal Reserve feed, execution, mint, broker-dealer registration.
...
UnyKorn LLC licenses software and infrastructure. Custody, where used, opens in the client’s name at a qualified custodian. Material here is information, not an offer of securities.
